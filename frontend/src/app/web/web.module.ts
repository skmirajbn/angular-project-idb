...
@NgModule({
  declarations: [HeaderComponent, FooterComponent, WebComponent, HomeComponent, AboutUsComponent, JobCategoryComponent, SidebarComponent, SpecialSkilledCategoryComponent, JobSpecialCategoryComponent, JobSearchComponent, JobsComponent, JobsSearchResultComponent, JobsFilterComponent],
